...
public class UserPostRestControllerIT extends SpringSimpleContextTest {
    ...
    @Test
    @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByUser_SuccessfulTest/BeforeTest.sql")
    @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByUser_SuccessfulTest/AfterTest.sql")
    public void getPostByUser_SuccessfulTest() throws Exception {
        String token = getToken("test", "test");
        mockMvc.perform(get("/api/v1/user/posts/user")
                        .header("Authorization", token)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.success", Is.is(true)))
    ...
    @Test
    @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByUser_PostNotFoundTest/BeforeTest.sql")
    @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByUser_PostNotFoundTest/AfterTest.sql")
    public void getPostByUser_PostNotFoundTest() throws Exception {
        String token = getToken("test", "test");
        mockMvc.perform(get("/api/v1/user/posts/user")
                        .header("Authorization", token)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByTags_SuccessfulTest/BeforeTest.sql")
    @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByTags_SuccessfulTest/AfterTest.sql")
    public void getPostByTags_SuccessfulTest() throws Exception {
        List<String> tags = List.of("like", "money");
        String token = getToken("test", "test");
        mockMvc.perform(post("/api/v1/user/posts/tags")
                        .header("Authorization", token)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByTags_PostByTagsNotFoundTest/BeforeTest.sql")
    @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD,
            value = "/scripts/user/UserPostRestController/getPostByTags_PostByTagsNotFoundTest/AfterTest.sql")
    public void getPostByTags_PostByTagsNotFoundTest() throws Exception {
